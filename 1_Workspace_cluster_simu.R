...
fun_para_analyse_cluster_TMLE <- function(itt_para,Scenario,n,Data_file,Resu_file){
  ...
  write.table(res_CL_TMLE_indvcov,file = paste(Resu_file,"/TMLE_analyse_indvcov",paste("/Data_output_CL_TMLE_indvcov_Scenario_",sep = "",n,".csv"),sep = ""),
              append = TRUE,row.names = FALSE,col.names = FALSE,sep = ";",dec = ",")
  
  write.table(res_CL_TMLE_bothcov,file = paste(Resu_file,"/TMLE_analyse_bothcov",paste("/Data_output_CL_TMLE_bothcov_Scenario_",sep = "",n,".csv"),sep = ""),
              append = TRUE,row.names = FALSE,col.names = FALSE,sep = ";",dec = ",")
